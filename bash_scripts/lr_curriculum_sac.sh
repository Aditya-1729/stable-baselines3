...
python /work/thes1499/DR_19_10/robosuite/stable-baselines3/time_curriculum/examples/lr_train_time_curriculum.py algorithm=lr_sac_curriculum task_config.reward_mode=2 controller.agent_config=0 algorithm.curriculum.steps=10 algorithm.curriculum.complete_handover=0.4 seed=9