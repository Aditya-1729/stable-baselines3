...
python /hpcwork/thes1499/10_8/robosuite/robosuite/time_curriculum/examples/train_time_curriculum.py task_config.reward_mode=2 seed=9 controller.agent_config=0 algorithm.curriculum.steps=20 algorithm.curriculum.complete_handover=0.05