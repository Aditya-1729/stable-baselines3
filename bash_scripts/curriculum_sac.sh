...
python /work/thes1499/19_10/robosuite/stable-baselines3/time_curriculum/examples/train_time_curriculum.py algorithm=sac_curriculum task_config.reward_mode=2 controller.agent_config=0 algorithm.curriculum.steps=9 algorithm.curriculum.complete_handover=0.2 seed=20