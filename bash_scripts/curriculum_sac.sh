...
python /work/thes1499/DR_19_10/robosuite/stable-baselines3/time_curriculum/examples/train_time_curriculum.py algorithm=sac_curriculum algorithm.curriculum.steps=10 algorithm.curriculum.complete_handover=0.2 seed=54